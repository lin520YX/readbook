...
<body id="page">
    <form action="include/movie.fun.php?deal=movie_pay"  method="post" name="form1" enctype="multipart/form-data" onSubmit="return checksignup()">
        <h2 style=" background-color:#0065AF;">&nbsp;&nbsp;添加支付方式</h2>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
         <td>
            <div style="margin-left:100px; float:left;">支付方式：&nbsp;&nbsp;<input type="text" name="title" value="" style="width:200px; height:16px; background-color:#FFFFFF;" />
            </div>
        </td>
        </tr>
        <tr>
