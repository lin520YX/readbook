...
include "session.php";
$Page_size=8; 
$sql="select * from admin where Admin_quanxian='1'";
...
$sql="select * from admin where Admin_quanxian='1' order by Admin_id desc limit $offset,$Page_size"; 
?>
<!DOCTYPE html>
<html>
<head>
...
<body id="page">
    <h2 style=" background-color:#0065AF;">&nbsp;&nbsp;管理帐户维护</h2>
        <table width="100%" cellpadding="0px" cellspacing="0px" border="0px" align="center">
            <tr bgcolor="#E3EFFB">
                <td height="30px" width="12%" align="center">管理账户</td>
                <td align="center" width="12%">管理员姓名</td>
                <td align="center" width="16%">身份证号</td>
                <td align="center" width="12%">管理员电话</td>
                <td align="center" width="12%">管理员邮箱</td>
                <td align="center" width="25%">管理员住址</td>
            ...
            <tr>
                ...
                <td align="center"><a href="update_admin.php?id=<?php echo $row['Admin_id'];?>">修改</a></td>
                <td align="center"><a href="../include/admin.fun.php?deal=delete&id=<?php echo $row['Admin_id'];?>">删除</a></td>
            </tr>
            <tr>
            ...
            ?>
<tr>   
<td colspan="8" bgcolor="#E3EFFB"><div align="center"><?php echo $key?></div></td>   
</tr>    
</table>
<?php
mysql_close();
