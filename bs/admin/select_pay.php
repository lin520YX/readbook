...
$sql="select * from pay order by id desc limit $offset,$Page_size"; 
?>
<!DOCTYPE html >
<html >
<head>
...
<body id="page">
<h2 style=" background-color:#0065AF;">&nbsp;&nbsp;管理支付方式</h2>
<table width="100%" cellpadding="0px" cellspacing="0px" border="0px" align="center">
<tr bgcolor="#E3EFFB">
<td height="30px" width="16%" align="center">支付方式ID</td>
<td align="center" width="16%">支付方式</td>
...
<td align="center"><a href="update_pay.php?id=<?php echo $row['id'];?>">修改</a></td> 
<td align="center"><a href="include/movie.fun.php?deal=delete_pay&id=<?php echo $row['id'];?>">删除</a></td>
</tr>  
 <tr>   
